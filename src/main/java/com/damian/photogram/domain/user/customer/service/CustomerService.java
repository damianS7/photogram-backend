package com.damian.photogram.domain.user.customer.service;
...
import com.damian.photogram.domain.user.customer.exception.CustomerEmailTakenException;
...
public class CustomerService {
    ...
    public Customer createCustomer(AccountRegistrationRequest request) {
        ...
        customer.getProfile().setUsername(request.username());
     ...
     * @throws CustomerNotFoundException if the logged user is not ADMIN
     */
    public Page<Customer> getCustomers(Pageable pageable) {
        // we return all the customer
